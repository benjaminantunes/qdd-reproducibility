...
# Use options to improve numerical reproducibility:
# -fno-fast-math: Disables optimizations that are not floating-point safe
# Consistently use -fdefault-real-8 and -fdefault-double-8 for precision
# -O2 is used instead of -Ofast for a balance between optimization and numerical consistency
# Note: -mfpmath=sse and -msse4.2 are removed to avoid forcing SSE instruction set usage,
#       letting the compiler choose the best floating-point strategy.
OPT1 = $(OMPADDL) -w -O0 -ffloat-store -fno-unsafe-math-optimizations -fno-associative-math -fno-reciprocal-math -fno-finite-math-only -fno-rounding-math -fno-cx-limited-range
OPT3 = $(OMPADDL) -w -O0 -ffloat-store -fno-unsafe-math-optimizations -fno-associative-math -fno-reciprocal-math -fno-finite-math-only -fno-rounding-math -fno-cx-limited-range

# Debugging options remain largely the same, with -O0 ensuring no optimization.
# Added -fno-fast-math to ensure floating-point operations are consistent even in debug mode.
ifeq "$(DEBUG)" "YES"
    OPT1 = $(OMPADDL) -pg -w -g -fbacktrace -O0 -ffloat-store -fno-unsafe-math-optimizations -fno-associative-math -fno-reciprocal-math -fno-finite-math-only -fno-rounding-math -fno-cx-limited-range
    OPT3 = $(OMPADDL) -pg -w -g -fbacktrace -O0 -ffloat-store -fno-unsafe-math-optimizations -fno-associative-math -fno-reciprocal-math -fno-finite-math-only -fno-rounding-math -fno-cx-limited-range
endif
